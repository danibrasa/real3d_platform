        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('admin.blog.posts.update', $post) }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="bg-white shadow-sm sm:rounded-lg p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <textarea name="excerpt" rows="2" class="w-full rounded-md border-gray-300 text-sm focus:border-blue-500 focus:ring-blue-500">{{ old('excerpt', $post->excerpt) }}</textarea>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Extracto (EN)</label>
                            <textarea name="excerpt_en" rows="2" class="w-full rounded-md border-gray-300 text-sm focus:border-blue-500 focus:ring-blue-500">{{ old('excerpt_en', $post->excerpt_en) }}</textarea>
                        </div>
                    </div>
                    ...
                    <div x-data="{ tab: 'write' }">
                        ...
                        <textarea x-show="tab === 'write'" name="body" id="body_es" rows="12" class="w-full rounded-md border-gray-300 text-sm font-mono focus:border-blue-500 focus:ring-blue-500">{{ old('body', $post->body) }}</textarea>
                    ...
                    <div x-data="{ tab: 'write' }">
                        ...
                        <textarea x-show="tab === 'write'" name="body_en" id="body_en" rows="12" class="w-full rounded-md border-gray-300 text-sm font-mono focus:border-blue-500 focus:ring-blue-500">{{ old('body_en', $post->body_en) }}</textarea>
                ...
                <div class="bg-white shadow-sm sm:rounded-lg p-6 space-y-6">
                    ...
                    <div>
                        ...
                        @if($post->featured_image_path)
                            <div class="mb-2">
                                <img src="{{ Storage::url($post->featured_image_path) }}" class="w-32 h-20 rounded object-cover" alt="">
                            </div>
                        @endif
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="featured_image_alt_en" value="{{ old('featured_image_alt_en', $post->featured_image_alt_en) }}"
                                   class="w-full rounded-md border-gray-300 text-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                    </div>
                ...
                <div class="flex justify-end gap-3">
                    ...
                    <button type="submit" class="px-6 py-2 bg-blue-600 text-white rounded-md text-sm font-semibold hover:bg-blue-700">Guardar Cambios</button>
                </div>
            </form>
        </div>
    </div>
