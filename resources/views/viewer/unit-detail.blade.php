...
<x-app-layout>
    ...
    <div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
            ...
            {{-- 8. CTA Banner #1 — Soft --}}
            @if($project->whatsapp_number)
            <section class="bg-gradient-to-r from-blue-50 via-indigo-50 to-blue-50 rounded-xl p-8 md:p-12 text-center">
                <h3 class="text-2xl font-bold text-gray-800 mb-3">{{ __('unit_detail.cta_interested_title') }}</h3>
                <p class="text-gray-600 mb-6 max-w-2xl mx-auto">{{ __('unit_detail.cta_interested_subtitle') }}</p>
                <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                    @php
                        $ctaWaNumber = preg_replace('/[^0-9]/', '', $project->whatsapp_number);
                        $ctaWaMessage = __('unit_detail.whatsapp_message', ['unit' => $unit->identifier, 'project' => $project->name]);
                    @endphp
                    <a href="https://wa.me/{{ $ctaWaNumber }}?text={{ urlencode($ctaWaMessage) }}" target="_blank" rel="noopener" class="inline-flex items-center px-6 py-3 bg-green-500 text-white rounded-lg text-sm font-semibold hover:bg-green-600 transition shadow">
                        <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
                        {{ __('landing.cta_whatsapp_btn') }}
                    </a>
                    <a href="#contacto" class="inline-flex items-center px-6 py-3 bg-blue-600 text-white rounded-lg text-sm font-semibold hover:bg-blue-700 transition shadow">
                        {{ __('landing.cta_contact_btn') }}
                    </a>
                </div>
            </section>
            @endif
            ...
            @if($project->whatsapp_number)
            <section class="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-xl p-8 md:p-12 text-center text-white">
                <h3 class="text-2xl font-bold mb-3">{{ __('landing.cta_ready_title') }}</h3>
                <p class="text-blue-100 mb-6 max-w-2xl mx-auto">{{ __('landing.cta_ready_subtitle') }}</p>
                <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                    <a href="https://wa.me/{{ $ctaWaNumber ?? preg_replace('/[^0-9]/', '', $project->whatsapp_number) }}?text={{ urlencode($ctaWaMessage ?? __('unit_detail.whatsapp_message', ['unit' => $unit->identifier, 'project' => $project->name])) }}" target="_blank" rel="noopener" class="inline-flex items-center px-6 py-3 bg-white text-blue-700 rounded-lg text-sm font-semibold hover:bg-blue-50 transition shadow">
                        <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
                        {{ __('landing.cta_whatsapp_btn') }}
                    </a>
                    <a href="#contacto" class="inline-flex items-center px-6 py-3 bg-white/20 text-white border border-white/30 rounded-lg text-sm font-semibold hover:bg-white/30 transition">
                        {{ __('landing.cta_contact_btn') }}
                    </a>
                </div>
            </section>
            ...
            {{-- 13. CTA Banner #3 — Urgency --}}
            @php
                $availableCount = $project->units->where('status', 'available')->count();
            @endphp
            @if($availableCount > 0 && $unit->status === 'available')
            <section class="bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 rounded-xl p-8 md:p-12 text-center">
                <span class="inline-flex items-center px-3 py-1 bg-amber-100 text-amber-800 rounded-full text-sm font-bold mb-4">
                    {{ $availableCount }}
                </span>
                <h3 class="text-2xl font-bold text-gray-800 mb-3">{{ trans_choice('unit_detail.cta_urgency_title', $availableCount) }}</h3>
                <p class="text-gray-600 mb-6 max-w-2xl mx-auto">{{ __('unit_detail.cta_urgency_subtitle') }}</p>
                <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                    @if($project->whatsapp_number)
                    <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $project->whatsapp_number) }}?text={{ urlencode(__('unit_detail.whatsapp_message', ['unit' => $unit->identifier, 'project' => $project->name])) }}" target="_blank" rel="noopener" class="inline-flex items-center px-6 py-3 bg-amber-500 text-white rounded-lg text-sm font-semibold hover:bg-amber-600 transition shadow">
                        <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
                        {{ __('landing.cta_whatsapp_btn') }}
                    </a>
                    @endif
                    <a href="#contacto" class="inline-flex items-center px-6 py-3 bg-amber-600 text-white rounded-lg text-sm font-semibold hover:bg-amber-700 transition shadow">
                        {{ __('landing.cta_contact_btn') }}
                    </a>
                </div>
            </section>
